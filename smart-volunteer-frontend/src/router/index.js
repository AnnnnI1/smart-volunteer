...
const routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'admin/publish-assistant',
        name: 'PublishAssistant',
        component: () => import('@/pages/organizer/PublishAssistant.vue'),
        meta: { requiresAuth: true, requiresManage: true }
      },
      {
        path: 'admin/users',
      ...
      {
        path: 'admin/feedback-center',
        name: 'FeedbackCenter',
        component: () => import('@/pages/admin/FeedbackCenter.vue'),
        meta: { requiresAuth: true, requiresAdmin: true }
      }
    ]
  }
