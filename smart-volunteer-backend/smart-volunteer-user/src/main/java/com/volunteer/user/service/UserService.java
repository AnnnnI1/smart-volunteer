...
public interface UserService extends IService<User> {
    ...
    ResponseResult listUsers(Integer role, Boolean applyOnly, Integer page, Integer size, String keyword,
                           Integer status, Integer creditScoreMin, Integer creditScoreMax,
                           String registerStart, String registerEnd);
